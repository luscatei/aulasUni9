...
do{
  ...
  echo "[5] - Alterar dados do produto......" . PHP_EOL;
  echo "[5] - Instruções de uso do sistema.." . PHP_EOL;
  echo "[6] - Sair.........................." . PHP_EOL;
  echo "**************************" . PHP_EOL;
  ...
  switch($opcao){
    case 1:
      ...
      $produto1 = new Produto(7482, "Coração", 10,00);
      $produto1->mostrarProduto();
      echo "Produto 2: " . PHP_EOL;
      $produto2 = new Produto(8922, "Maminha", 47,70);
      $produto2->mostrarProduto();
      echo "Produto 3: " . PHP_EOL;
      $produto3 = new Produto(4002, "Picanha Suina", 37,50);
    ...
    case 5:
      ...
      $preco = fgets(STDIN);
      if($codigo == 1){
        $produto1->alterarProduto($codigo, $nome, $preco);
      }elseif($codigo == 2){
        $produto2->alterarProduto($codigo, $nome, $preco);
      }elseif($codigo == 3){
        $produto3->alterarProduto($codigo, $nome, $preco);
      }else{
        echo "Produto não encontrado!" . PHP_EOL;
      }
      break;
